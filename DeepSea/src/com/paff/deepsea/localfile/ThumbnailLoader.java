...
import com.paff.deepsea.compatibility.BitmapDrawable_Compatible;
...
public class ThumbnailLoader extends Thread
{
	...
	private static final String TAG = "DSFE_ThumbnailLoader";
			...
			try
			{
				...
				if (options.outWidth > 0 && options.outHeight > 0)
				{
					...
					if (bitmap != null)
					{
						...
						BitmapDrawable drawable = BitmapDrawable_Compatible.getNewBitmapDrawable(
						...
						Message msg = handler.obtainMessage(FileExplorerActivity.MESSAGE_ICON_CHANGED);
						msg.obj = text;
						msg.sendToTarget();
					}
				}
