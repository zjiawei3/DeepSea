...
public class FileExplorerProvider extends ContentProvider
{
	static final String FILE_PROVIDER_PREFIX = "content://com.paff.deepsea";
	private static final String TAG = "FileExplorerProvider";
	public static final String AUTHORITY = "com.paff.deepsea";
	...
	public Cursor query(Uri uri, String[] projection, String s, String[] as1, String s1)
	{
		if (uri.toString().startsWith(FILE_PROVIDER_PREFIX))
		{
			if (projection == null || projection.length == 0)
			{
				...
				projection = new String[] { MediaStore.MediaColumns.DATA, MediaStore.MediaColumns.MIME_TYPE,
			...
			String displayName = (fromIndex > 0) ? data.substring(fromIndex) : data;
